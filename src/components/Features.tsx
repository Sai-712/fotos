...
const features = [
  ...
  },
  {
    ...
    description:
      'Never lose a photo again. Fotos automatically backs up your photos from your phone, computer, and other devices.',
    icon: Camera,
  },
  {
    name: 'Smart Editing',
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:text-center">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-600">
            Fotos combines powerful organization tools with seamless sharing capabilities to give you complete control over your photo library.
          </p>
        </div>
